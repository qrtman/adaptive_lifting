...
- **Surfaces**: Calendar = click a day to open the session (empty day creates one). Sessions = group/filter by Block/Week when present; ungrouped bucket otherwise. Coach shell has an athlete switcher that drives Calendar/Sessions.
