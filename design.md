...
| `SetGrid` | structured cells (planned/actual load, reps, RPE, notes) | idle, selected, editing, pending, locked, invalid | keyboard commit, fill-down, copy/paste | Replaces ExerciseCard / PrescriptionEditor. Tokens only. `MovementPatternSelect` on the exercise header. |
